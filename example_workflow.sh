...
python src/feature_selection.py --config configs/feature_selection.json --model_path ${selector_path} --model_type selector_mlp

echo "Step 5: Performing feature selection with SVM..."
python src/feature_selection.py --config configs/feature_selection.json --model_path ${svm_model} --model_type svm
